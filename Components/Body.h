...
public:
	...
	void Integrate(float g,float dT);
	void Serialize(struct bodyval *sbody);
	void Initialise();
    void HandleEvent(Event *pEvent);

public:
	//float mPosX, mPosY, mPrevPosX, mPrevPosY, mVx, mVy, mAx, mAy, mForceX, mForceY, mMass, mInvMass;
	glm::vec3 mBodyPos,mPrevBodyPos, mBodyVel, mBodyAcc, mBodyForce;
